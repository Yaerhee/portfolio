        ...
        <Flex w="full" justifyContent="center">
          <Flex w="full" flexDirection="column" gap={4}>
            <Flex alignItems="center" gap={2}>
              <Text fontWeight="900" fontSize="30px" py={2}>
                <Link
            ...
            <Divider borderWidth="2px" borderColor="orange.100" opacity="0.6" />
            <Flex flexDirection="column" my={4}>
              ...
              <UnorderedList spacing={3} fontSize="md" pl={8}>
                <ListItem pt={3}>
            ...
            <Flex flexDirection="column">
              ...
              <UnorderedList spacing={3} fontSize="md" pl={8}>
                <ListItem>
                  ECC 알고리즘 암/복호화 지원을 위한 Emscripten + CMake 로의
                  compile 작업
                  <UnorderedList
                    py={3}
                    styleType="circle"
                  ...
                  >
                    ...
                    <ListItem>
                      Emscripten + 추가 cpp 로직 설계 및 CMakeList 작업으로 .js,
                      .wasm 파일 컴파일
                    </ListItem>
                    <ListItem>
              ...
              <UnorderedList spacing={3} fontSize="md" pl={8}>
                ...
                <ListItem>
                  고객사 이슈에 대한 지속적인 대응 중 {`->`} 빠르고 정확한
                  유지보수를 통한 모듈 사용성 향상
                </ListItem>
                <ListItem>
                  고객사 및 키패드 팀 동료와의 원활한 소통을 위한 문서화 작업
                  진행, 상세 활용 가이드 작성 및 <br /> 버전 리스트 운영
                </ListItem>
              </UnorderedList>
            </Flex>
          </Flex>
        ...
        <Flex w="full" justifyContent="center" mt={20}>
          <Flex w="full" flexDirection="column" gap={4}>
            <Flex alignItems="center" gap={2}>
              <Text fontWeight="900" fontSize="30px" py={2}>
                <Link
                  href="https://www.planit-healthcare.com/"
                  color="orange.800"
                  isExternal
                >
            ...
            <Divider borderWidth="2px" borderColor="orange.200" opacity="0.6" />
            <Flex flexDirection="column" my={4}>
              <Text
                fontSize="md"
                fontWeight="bold"
              ...
              <UnorderedList spacing={3} fontSize="md" pl={8}>
                ...
                <ListItem>
                  데이터 품질 인증 Gold Class 취득을 목표로 앱 구현 (최소 공신력
                  인정 단계)
                </ListItem>
                <ListItem>
                  진단 대상 테이블 설정 후, 규칙 쿼리 & 계획 설정하여 진단
                  수행하는 기능 구현
                </ListItem>
                <ListItem>
                ...
                <ListItem>
                  실제 병원 지표 CDW(Clinical Data Warehouse) 데이터 추가 후, 앱
                  진단 규칙 실행으로 데이터가 오기재된 테이블을 10건 이상 발견 →
                  수정후 데이터 재 적재 완료
                  <UnorderedList
                    py={3}
                    styleType="circle"
                  ...
                  >
                    <ListItem>
                      CDW - 병원 임상 데이터를 비식별화해 저장 후, 연구자의
                      필요에 따라 검색/ 분석 가능하도록 하는 서비스
                    </ListItem>
                  </UnorderedList>
                </ListItem>
              </UnorderedList>
            ...
            <Flex flexDirection="column">
              ...
              >
                <TaskIcon boxSize={8} m={0} />
                BICI_Cloud - 대시보드, 임상지표 웹 어플리케이션 (1세대) 유지보수
                - 신규 지표 추가 및 버그 fix
              </Text>
              <UnorderedList py={3} spacing={3} fontSize="md" pl={8}>
                <ListItem>
                  지표 별 수정 필요한 기능 반영 (ex. Vue 필터 기능 추가, 공휴일
                  필터링 API 등)
                </ListItem>
                <ListItem>
                  신규 지표 추가 및 관련 로직 일괄 구현 (분석, 추이 차트,
                  그리드, 피벗 로직)
                </ListItem>
                <ListItem>
                  총 신규 정의 지표 페이지 약 5 건, 치명적인 버그 3건 해결
                  <OrderedList py={3} spacing={3} fontSize="md" pl={4}>
                    <ListItem>
                      그리드 컬럼 DnD 미적용 버그 해결 (return Object 구조 및 JS
                      로직 수정)
                    </ListItem>
                    <ListItem>
                      피벗 소계 계산 버그 (긴급 수정 오류) - DB DataType 조건
                      수정하여 해결
                    </ListItem>
                    <ListItem>
                      환자현황 지표 입원 - 재원 변환 로직 누락 해결 (Vue state
                      추가, 로직 추가)
                    </ListItem>
                  </OrderedList>
                </ListItem>
            ...
            <Flex flexDirection="column">
              ...
              >
                <TaskIcon boxSize={8} m={0} />
                InsightEx - 대시보드, 임상지표 웹 어플리케이션 (2세대) 유지보수
                - 신규 대시보드 추가 및 로직 수정
              </Text>
              <UnorderedList py={3} spacing={3} fontSize="md" pl={8}>
                <ListItem>
                  ...
                  설정된 지표 데이터가 테이블에 저장 및 <br />
                  select 되도록 로직 구현)
                </ListItem>
                <ListItem>
                  그리드, 피벗 단의 뷰 이름 중복 체크 로직 추가 (axios fetch 로
                  실시간 체크)
                </ListItem>
                <ListItem>
                  관리자 메뉴 - 유저 설정 뷰 템플릿 조회 화면의 redux - setState
                  오류 해결
                </ListItem>
                <ListItem>
                  중복 코드 & 사용하지 않는 코드 정리 및 비효율적인 로직
                  리팩토링
                </ListItem>
                <ListItem>
                  다양한 DB (Oracle, MSSQL 등) 에 대한 Mapper xml 쿼리 수정 및
